...
!     &        TcondSat(1),TCondSat(2),ASTCOND,
!     &        STBot(1),STBot(2),AMP(1),AMP(2),
!     &        DampDa,DampDw,     
!     &        AHeatCap,Del,STa(1),STa(2),
!     &        STboti(1),STboti(2),AMPi(1),AMPi(2)
  300     FORMAT(1X,I4,1X,I3.3,1X,I5,9F8.1)
!     &           2F8.1,12F8.2,21F8.3,4F8.2,2F12.0,E15.4,7F8.2)
        END IF   ! VSH
